  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-4 gap-8">
      ...
      <aside className="bg-gray-100 p-4 rounded space-y-6">
        ...
        <div>
          <p className="font-semibold mb-1">Max Price ₹{maxPrice}</p>
          <input
            type="range" min="300" max="1000" step="100"
            value={maxPrice}
      ...
      <section className="md:col-span-3">
        <h2 className="text-3xl font-bold mb-6">Shop All Headphones</h2>
